    ...
    switch (req.call_collection) {
      ...
      case 'genome':
        req.fieldHeader = [
          ...
          'BioProject Accession', 'BioSample Accession', 'Assembly Accession', 'SRA Accession', 'GenBank Accessions',
          'RefSeq Accessions',
        ...
        req.fieldSelection = [
          ...
          'bioproject_accession', 'biosample_accession', 'assembly_accession', 'sra_accession', 'genbank_accessions',
          'refseq_accessions',
