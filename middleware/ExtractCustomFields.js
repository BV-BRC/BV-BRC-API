  ...
  if (parsed && parsed.query && parsed.query.fl) {
    ...
    switch (req.call_collection) {
      case 'genome_feature':
        ...
        break
      case 'genome':
        req.fieldHeader = ['Genome ID', 'Genome Name', 'Other Names', 'NCBI Taxon ID', 'Taxon Lineage IDs', 'Taxon Lineage Names', 'Superkingdom', 'Kingdom', 'Phylum', 'Class', 'Order', 'Family', 'Genus', 'Species', 'Genome Status', 'Strain', 'Serovar', 'Biovar', 'Pathovar', 'MLST', 'Segment', 'Subtype', 'H_type', 'N_type', 'H1 Clade Global', 'H1 Clade US', 'H5 Clade', 'pH1N1-like', 'Lineage', 'Clade', 'Subclade', 'Other Typing', 'Culture Collection', 'Type Strain', 'Reference', 'Genome Quality', 'Completion Date', 'Publication', 'Authors', 'BioProject Accession', 'BioSample Accession', 'Assembly Accession', 'SRA Accession', 'GenBank Accessions', 'Sequencing Center', 'Sequencing Status', 'Sequencing Platform', 'Sequencing Depth', 'Assembly Method', 'Chromosome', 'Plasmids', 'Contigs', 'Size', 'GC Content', 'Contig L50', 'Contig N50', 'TRNA', 'RRNA', 'Mat Peptide', 'CDS', 'Coarse Consistency', 'Fine Consistency', 'CheckM Contamination', 'CheckM Completeness', 'Genome Quality Flags', 'Isolation Source', 'Isolation Comments', 'Collection Date', 'Collection Year', 'Season', 'Isolation Country', 'Geographic Group', 'Geographic Location', 'Other Environmental', 'Host Name', 'Host Common Name', 'Host Gender', 'Host Age', 'Host Health', 'Host Group', 'Lab Host', 'Passage', 'Other Clinical', 'Additional Metadata', 'Comments', 'Date Inserted', 'Date Modified']

        req.fieldSelection = ['genome_id', 'genome_name', 'other_names', 'taxon_id', 'taxon_lineage_ids', 'taxon_lineage_names', 'superkingdom', 'kingdom', 'phylum', 'class', 'order', 'family', 'genus', 'species', 'genome_status', 'strain', 'serovar', 'biovar', 'pathovar', 'mlst', 'segment', 'subtype', 'h_type', 'n_type', 'h1_clade_global', 'h1_clade_us', 'h5_clade', 'ph1n1_like', 'lineage', 'clade', 'subclade', 'other_typing', 'culture_collection', 'type_strain', 'reference_genome', 'genome_quality', 'completion_date', 'publication', 'authors', 'bioproject_accession', 'biosample_accession', 'assembly_accession', 'sra_accession', 'genbank_accessions', 'sequencing_centers', 'sequencing_status', 'sequencing_platform', 'sequencing_depth', 'assembly_method', 'chromosome', 'plasmids', 'contigs', 'genome_length', 'gc_content', 'contig_l50', 'contig_n50', 'trna', 'rrna', 'mat_peptide', 'cds', 'coarse_consistency', 'fine_consistency', 'checkm_contamination', 'checkm_completeness', 'genome_quality_flags', 'isolation_source', 'isolation_comments', 'collection_date', 'collection_year', 'season', 'isolation_country', 'geographic_group', 'geographic_location', 'other_environmental', 'host_name', 'host_common_name', 'host_gender', 'host_age', 'host_health', 'host_group', 'lab_host', 'passage', 'other_clinical', 'additional_metadata', 'comments', 'date_inserted', 'date_modified']
